...
Original file is located at
    https://colab.research.google.com/drive/1nJE_Uj1zNKyuM43lnqvxDRnhcpAyC6PC
"""
    ...
    def build_encoder(self):
        ...
        for i, n_layer in enumerate(self.g_n_layers[1:]):
            if i == 0:
                ...
                model.add(Embedding(vocab_size=82, pct_bpe=0.2, word_tokenizer=None,
                 silent=True, ngram_min=2, ngram_max=2, required_tokens=None, strict=False, UNK=DEFAULT_UNK, PAD=DEFAULT_PAD))
